      ...
      >
        ...
        <ul className="flex flex-col gap-8 pt-10 md:pt-0">
          ...
          <Link onClick={(e) => setIsOpen(false)} href="/factors">
            <li
              className={`flex gap-4 font-bold text-xs text-[#606C80] ${
                isActive("/factors") ? "text-blue-500" : "text-gray-500"
              }`}
            >
          ...
          <Link onClick={(e) => setIsOpen(false)} href="/outOfWarranty">
            <li
              className={`flex gap-4 font-bold text-xs text-[#606C80] ${
                isActive("/outOfWarranty") ? "text-blue-500" : "text-gray-500"
              }`}
            >
              <Requests
          ...
          <Link onClick={(e) => setIsOpen(false)} href="/BuyVipCard">
            <li
              className={`flex gap-4 font-bold text-xs text-[#606C80] ${
                isActive("/BuyVipCard") ? "text-blue-500" : "text-gray-500"
              }`}
            >
              <Requests
          ...
          <Link onClick={(e) => setIsOpen(false)} href="/requests">
            <li
              className={`flex gap-4 font-bold text-xs text-[#606C80] ${
                isActive("/requests") ? "text-blue-500" : "text-gray-500"
              }`}
            >
          ...
          <Link onClick={(e) => setIsOpen(false)} href="/availability">
            <li
              className={`flex gap-4 font-bold text-xs text-[#606C80] ${
                isActive("/availability") ? "text-blue-500" : "text-gray-500"
              }`}
            >
