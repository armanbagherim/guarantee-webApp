...
const PickTechnicalUserWithVisitTime = ({ currentOperation, nodeCommands, setAction, setTriggered, triggered, session, ...node }) => {
    ...
    const fetchOrganizationAddress = async () => {
        try {
            ...
            toast.error("خطا در دریافت آدرس سازمان");
        }
    };
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
                <h4 className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-2">
                        <span className="text-primary font-bold">ارسال کالا به نمایندگی </span>
                        <span className="font-bold">{organizationAddress?.orgnizationDetail?.name}</span>
                    </div>
                    <div className="flex items-center gap-2">
