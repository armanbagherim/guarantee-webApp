...
export default function AssignProducts({ token }) {
    ...
    const fetchProducts = async () => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/v1/api/guarantee/client/assignedProductGuarantees/guarantee/${guaranteeId}`, {
                method: "GET",
                headers: {
        ...
        <div className="bg-white p-6 rounded-[25px] request">
            ...
            <div className="relative mb-8">
                {submitLoading ? (
                    ...
                    <button
                        onClick={saveData}
                        disabled={!productType || !selectedBrand || !selectedVariant}
