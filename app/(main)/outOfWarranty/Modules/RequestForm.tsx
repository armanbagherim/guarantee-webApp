...
import ServerSelect from "@/app/components/admin-components/ServerSelect";
...
export default function RequestForm({ requestTypes, token }) {
  ...
  const [selectedVaraint, setSelectedVaraint] = useState(null);
    ...
    <div className="bg-white p-6 rounded-[25px] request">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <ServerSelect
          ...
          token={token}
          onChange={(productId) => setProductType(productId)}
        ...
        <ServerSelect
          ...
          token={token}
          onChange={(productId) => setSelectedBrand(productId)}
          shouldLoadInitialOptions={true}
        ...
        <ServerSelect
          ...
          token={token}
          onChange={(productId) => setSelectedVaraint(productId)}
          shouldLoadInitialOptions={true}
