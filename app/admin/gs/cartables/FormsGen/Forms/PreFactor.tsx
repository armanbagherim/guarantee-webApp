        ...
        <div className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className={`p-6 rounded-2xl text-center shadow-sm ${factor.remainingAmount < 0 ? "bg-red-50" : "bg-green-50"}`}>
                    <Typography variant="subtitle1" className={`font-medium ${factor.remainingAmount < 0 ? "text-red-700" : "text-green-700"}`}>
            ...
            <div className="border-t pt-8">
                <Typography variant="body1" className="mb-4 text-lg font-medium text-gray-700">
                    {factor.isAvailableForOnlinePayment
                        ? "مشتری چطور پرداخت کند؟"
                        : "مشتری وجه را به صورت نقدی پرداخت می‌کند."}
                </Typography>
            ...
            {/* آپلود تصویر محصول */}
            <div className="mt-8">
                <Typography variant="subtitle1" className="mb-4 font-bold text-gray-800">
                    آپلود تصویر محصول (در صورت نیاز)
                </Typography>
                <Uploader
                    photos={photos}
                    setPhotos={setPhotos}
